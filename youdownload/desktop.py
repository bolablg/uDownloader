...
from PyQt6.QtWidgets import (
    ...
    QTabWidget, QLineEdit, QPushButton, QComboBox, QCheckBox,
    QLabel, QListWidget, QListWidgetItem, QTableWidget, QTableWidgetItem,
    QDialog, QSpinBox, QFileDialog, QScrollArea, QMessageBox, QSplitter,
...
class DownloadWorker(QObject):
    ...
    def run_download(self, url: str, download_id: str, audio_only: bool):
        ...
        try:
            ...
            self.finished.emit(download_id, {
                "success": False,
                "error": str(e),
                "url": url,
            })
...
class uDownloaderApp(QMainWindow):
    ...
    def create_download_tab(self) -> QWidget:
        ...
        self.download_btn.setStyleSheet("background-color: #4CAF50; color: white; font-weight: bold; padding: 10px;")
    ...
    def create_queue_tab(self) -> QWidget:
        ...
        self.queue_table.setHorizontalHeaderLabels(["Title", "Platform", "Progress", "Status", "Action"])
    ...
    def create_history_tab(self) -> QWidget:
        ...
        self.history_table.setHorizontalHeaderLabels(["Title", "Platform", "Status", "Date", "View"])
